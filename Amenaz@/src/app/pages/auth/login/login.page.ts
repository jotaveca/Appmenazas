...
export class LoginPage implements OnInit {
  ...
  constructor( private modalController: ModalController, private authService: AuthService, private navCtrl: NavController, private alertService: AlertService, public events: EventsService ){
