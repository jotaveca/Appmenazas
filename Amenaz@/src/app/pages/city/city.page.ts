...
export class CityPage implements OnInit {
  ...
  constructor( private mappingService: MappingService, private route: ActivatedRoute, private router: Router, private modalController: ModalController, public alertController: AlertController, private menu: MenuController, private popoverController: PopoverController, private event: EventsService
  ) {
